  ...
  module V1
    class NotificationsController < ApplicationController
      def index # rubocop:disable Metrics/AbcSize, Metrics/MethodLength
        notifications = current_api_v1_user.passive_notifications.eager_load(:visitor,
                                                                             :tweet).where.not(visitor_id: current_api_v1_user.id) # rubocop:disable Layout/LineLength
